...
## Mixed Reality Implementation Using Varjo XR-3 and HDRP in Unity
  ...
  <p align="center">
    <img src="ReadmeFiles/ENV2.png" width="45%" alt="Environment2">
    <img src="ReadmeFiles/ENV1.png" width="45%" alt="Environment1">
  </p>
...
## Environment
  ...
  <p>
    <img src="ReadmeFiles/TOPDOWNMAP.png" width="47.73%" alt="Top Down Map">
    <img src="ReadmeFiles/CityTOP.png" width="42.27%" alt="Top Down Map">
  </p>
...
### Hierarchy of the Environment
  <p>
    <img src="ReadmeFiles/Hierarchy.png" height="500" alt="Hierarchy_Environment">
  </p>
...
## IVIS
  ...
  <p align="center">
    <img src="ReadmeFiles/MapScreen.png" width="700" alt="IVIS">
  </p>
  ...
  <p align="center">
    <img src="ReadmeFiles/StartScreen.png" width="44.5%" alt="IVIS Start Screen">
...
2. **Missing Script**
   ...
   - Compare inspector to reference screenshot to confirm setup.
    <p>
      <img src="ReadmeFiles/Pedestrian_Inspector_Overview.png" height="500" alt="Pedestrian inspector overview">
    </p>
